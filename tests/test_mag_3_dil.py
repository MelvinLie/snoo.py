...
if cwd.split('\\')[-1] == 'examples':
    test_directory = os.path.join('..', 'files', 'tests', 'test_mag_3_dil')
...
assert M_i == 211835719.68
assert M_c == 219941.53877284116
assert Q == 11876.843093733421
assert J == 5228345.170351607
