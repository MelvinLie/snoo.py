...
def compute_stiffness_and_jacobi_matrix_curl_curl_diluted(nodes, cells, glob_ids, curls, phi, d_phi, orientations, x, B_s, reluctance, dilution, q, w, num_dofs, num_el_dofs):
    '''Compute the stiffness matrix and the jacobian for the magnetic vector potential formulation.
    ...
    :param dilution:
        A dilution object. See the definition in materials.py.
    ...
    # make the c type dilution object
    cdef ctools.dilution* dil_c = ctools.make_dilution(dilution.c_num, dilution.m_num,
                                                        dilution.c_den, dilution.m_den)
    ...
    if len(B_s) == 0:
        ...
        ctools.compute_K_dK_Hcurl_red_dil(triplets_K_c, 
                                  triplets_dK_c,
                                  rhs_c,
                                  dil_c,
                                  glob_ids_c,
